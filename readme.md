...
Есть с десяток мест где можно оптимизировать.Практический опыт работы с Docker: особенности инструмента + аналоги и их различия, написание Dockerfiles + docker-compose
...
* вот мое решение ![image](https://github.com/user-attachments/assets/d0e203ac-76e9-4d9f-b08e-13ad9c42c91d)

* решение лабы ![image](https://github.com/user-attachments/assets/a32e343c-a796-4dd3-92cd-b98150b2b453)
* В итоге на 24 процента оптимизировали время выполнения итерации и на 20 процентов сократили расходы памяти на одну итерацию , справились с заданием .

![image](https://github.com/user-attachments/assets/269daa96-ee46-4fb5-9073-72f804d2f496)
